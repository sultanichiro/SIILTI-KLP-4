        ...
        <div class="container mx-auto center">
            <div class="bg-white p-6 rounded-lg w-96 md:w-1/4">
                <div class="text-center">
                    ...
                    <p class="text-sm text-slate-400 mt-2 font-semibold">Dashboard</p>
                    <p class="font-bold text-xl mt-5">Login to SIILTI</p>
                ...
                <div class="mt-10">
                    ...
                    <form action="{{route('login')}}" method="post">
                        ...
                        <p class="text-center text-xs text-slate-400 mt-5">Dont have an account? <span class="text-teal-500 font-semibold">Sign Up</span></p>
                    </form>
                </div>
            </div>
        </div>
