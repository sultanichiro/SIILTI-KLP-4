        ...
        <div class="container mx-auto center">
            <div class="bg-white p-6 rounded-lg w-96 md:w-1/4">
                <div class="text-center">
                    ...
                    <p class="font-bold text-xl mt-5">Login to SIILTI</p>
                ...
                <div class="mt-10">
                    ...
                    <form action="{{route('login')}}" method="post">
                        ...
                        <div class="border mt-2 p-2 @error('password') border-red-500 @enderror">
                          ...
                          @enderror
                        <div>
                          <a href="{{ route('forgot-password') }}" class="text-left text-xs text-slate-400">Forgot password?</a>
                        </div>
                        <div class="row">
                          <div class="col-8">
                        ...
                        <p class="text-center text-xs text-slate-400 mt-5">Dont have an account? 
                          <a href="{{ route('register') }}"><span class="text-teal-500 font-semibold">Sign Up</span></a>
                        </p>
                    </form>
                </div>
            </div>
