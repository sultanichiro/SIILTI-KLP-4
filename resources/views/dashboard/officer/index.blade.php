        ...
        <div class="bg-white mt-5 p-5 rounded-lg">
            <div class="flex justify-between">
                <div class="text-left">
                    ...
                    <a href="/input-petugas" class="text-sm inline-block bg-blue-700 text-white px-2 py-1 items-center justify-center">
                        <i class="ri-add-line"></i>
                    </a>
                    <a href="/excel/user" class="text-sm inline-block bg-green-700 text-white px-2 py-1 items-center justify-center">
                        <i class="ri-file-excel-2-line mr-2"></i>
                    </a>
                    <a href="/input-import-petugas" class="text-sm inline-block bg-green-700 text-white px-2 py-1 items-center justify-center">
            ...
            <table class="w-full mt-5 text-sm text-gray-600">
                ...
                <tbody>
                    ...
                    @foreach ($officers as $officer)
                        ...
                        <td class="p-2">{{ $officer->roles->pluck('name')->first() }}</td>
