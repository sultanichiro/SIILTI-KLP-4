...
<div class="container px-4">
    <div class="bg-white mt-5 p-5 rounded-lg">
        <div class="text-left">
            ...
            <a href="/mahasiswa" class="text-sm inline-block bg-gray-700 text-white mt-2 px-2 py-1">Kembali</a>
        </div>

        <form action="/import/mahasiswa" method="POST" enctype="multipart/form-data" class="mt-5">
            @csrf
            <div class="mb-4">
