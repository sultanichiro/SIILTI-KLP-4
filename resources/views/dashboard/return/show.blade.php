...
<div class="container px-4">
    <div class="bg-white p-5 mt-5 rounded-lg shadow-md">
        <div class="flex items-center justify-between mb-5">
            <h2 class="text-gray-600 font-bold text-lg">Detail Saran Mahasiswa</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="mt-3 col-span-2">
                ...
                <div class="border-2 bg-gray-100 p-2 rounded">
                    <textarea name="desc" class="text-black w-full h-20 focus:outline-none text-sm bg-transparent" id="desc" rows="3" readonly placeholder="Tidak ada saran atau komentar yang diberikan">{{ $transaction->desc }}</textarea>
                </div>
            </div>
        </div>
    </div>
