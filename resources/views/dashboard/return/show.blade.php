...
<div class="container px-4">
    <div class="bg-white p-5 mt-5 rounded-lg">
        ...
        <form action="/saran-barang-userp/{{ $return->id }}" method="POST" class="w-full mt-5">
            @csrf
            <div class="mt-3">
                ...
                <div class="border-2 p-1 @error('desc') border-red-400 @enderror">
                    <textarea name="desc" value="{{ $transaction->desc }}" class="text-black w-full h-20 focus:outline-none text-sm" id="desc" disabled></textarea>
                </div>
                @error('desc')
